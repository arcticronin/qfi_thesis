...
\begin{remark}[Quantum natural gradient]
    ...
    The quantum natural gradient rescales the ordinary gradient according to the local distinguishability of neighboring ansatz states. It is a geometry-aware optimization direction; an application to VQSE is presented in Section~\ref{sec:vqse_qng_optimization}.
\end{remark}
