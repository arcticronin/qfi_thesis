...
\begin{landscape}
    \begin{figure}[p]
        ...
        \begin{subfigure}[t]{0.65\textwidth}
            \centering
            \includegraphics[height=0.68\textheight,keepaspectratio]{figures/diagrams/diagram_Choi_to_kraus_extended_proof.jpg}
        ...
        \begin{subfigure}[t]{0.30\textwidth}
            \centering
            \includegraphics[height=0.68\textheight,keepaspectratio]{figures/diagrams/diagram_stinespring_to_kraus_extended_proof.jpg}
        ...
        \end{subfigure}
        \caption{Extended graphical derivations of the Kraus representation from the Choi and Stinespring forms.}
    \end{figure}
\end{landscape}
