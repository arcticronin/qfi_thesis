...
There are **17 main slides and 10 appendix slides**. Slide 3 has seven successive measurement-basis overlays, so the PDF contains **33 pages**. Advance normally through angles 0°, 15°, 30°, 45°, 60°, 75° and 90°. The state and QFI remain fixed while the measurement axis and CFI marker move. All seven pages retain slide number 3 / 17; no animation-capable PDF viewer is required.
...
- **Measurement overlays:** native TikZ in [assets/measurement_overlay.tex](assets/measurement_overlay.tex). The exact mixed-qubit model has Bloch radius 0.8 and QFI 0.64. The control angle changes the measurement, not the parameter being estimated. Appendix J gives the derivation.
